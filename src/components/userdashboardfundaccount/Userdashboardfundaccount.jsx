...
const Userdashboardfundaccount = () => {
  ...
  const depositOptions = [
    {
      ...
      image:'/btc.png',
      method:'BTC',
      wallet:'bc1q4ry8lxukfewg5svdmqytlq3j5eu70xzgjmqufh',
    },
    {
      id:2,
      min:1,
      ...
      image:'/etherium.png',
      method:'ETH',
      wallet:'0xc5f78f2243781611638D5Defe7F3B61F0b12f765'
    },
    {
      id:3,
      min:1,
      ...
      wallet:'TNanVa8quELy7PR821uZUq84dboGGDSfzS'
    },
    {
      id:4,
      min:1,
    ...
    },
    {
      ...
      image:'/solana.png',
      method:'Solana (SOL) ',
      wallet:'BuHAkXgnA8pZ26xYcwv2GNydPcA2ZXoAg2ZL7xKHgfq4'
    },
    {
      id:6,
      min:1,
      ...
      method:'Dogecoin ',
      wallet:'DLxBiNNZ8ofhmCpRBhDZjZrUhdw67xX2xA'
    },
    {
      id:7,
      min:1,
      ...
      image:'/xrp-icon.png',
      method:'XRP ',
      wallet:'rT7v1iLfBktCHirSZuXeXMUtAnwgd5dLY'
    },
  ]
  ...
  return (
    <>
      ...
      {
        checkoutPage &&
        <Checkout Active={activeMethod} depositAmount={depositAmount} closepage={close} />
      }
    </>
  )
}
