      ...
      <div className="referral-page-container">
        <div className="referral-hero-section" data-aos="fade-up">
          <div className="referral-hero-text">
            ...
            <p>Invite your friends to join <b>ChartSynch</b> and earn <b>10% commission</b> on every deposit they make. Build your network and watch your earnings grow!</p>
          </div>
          <div className="referral-link-card">
            ...
            <div className="referral-input-group">
              ...
              <input
                type="text"
                readOnly
                value={userData ? `www.chartsynch.com/user/${userData.username || userData.referral}` : 'Loading...'}
                ref={clipRef}
              />
